...
--exceptions:
  goto
--d:
  nimPreviewFloatRoundtrip # Avoid using sprintf as it's not available in wasm

let llTarget = "wasm64-unknown-unknown-wasm"
...
var linkerOptions =
  "-nostdlib -Wl,--no-entry,--allow-undefined,--gc-sections,--strip-all"
